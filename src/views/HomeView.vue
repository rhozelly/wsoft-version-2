...
const additionalServices = [
  {
    title: '1.디자인',
    content: '템플릿 디자인사용 발주자의 디자인사용 디자인 시안제작',
  },
  {
    title: '2. 관리자기능',
    content: '기본조회, 편집기능 재고관리 배송관리 일간/주간 통계 정산',
  },
  {
    title: '3. 편집 및 업로드기능',
    content: '이지웍 에디터 이미지, 파일 업로드기능 유튜브영상 임베드기능 음성, 영상 업로드 재생 태그자동완성(자주입력하는 순으로 해시태그) 그래프표시',
  },
  {
    title: '4. 커뮤니티기능',
    content: '견적산출 구인/구직 ( 양방향 의뢰요청) 단계별 의뢰, 설문 질문, 답변기능 (등급, 포인트 없는경우) 판매자,업체 대시보드 (상품등록, 구매확인) 룹웨어 (작업자설정, 진행상태변경, 태스크등록) 초대기능(초대시 리워드지급기능)',
  },
  {
    title: '5.고급기능',
    content: '캘린더 UI 지도위에 팝업(요약정보 지도위에 팝업) 지도위의 핀과 결과목록 연동 리캡차( 검색봇, 매크로등을 걸러내는 인증기능)',
  },
  {
    title: '6. 서비스 플랫폼',
  ...
  {
    title: '7. 회원가입/로그인',
    content: '이메일가입/로그인 휴대폰인증 실명인증 SNS웹로그인 SNS모바일로그인 비로그인 구매 아이디, 비밀번호 찾기',
  },
  {
    title: '8. 아이템목록, 상세',
    content: '아이템목록, 상세 찜하기 리뷰,별점',
  },
  {
    title: '9. 알림관련기능',
    content: '개별푸시알림 국내 SMS알림 국제 SMS알림 이메일알림 카카오톡알림 가상번호(수신자전화번호 숨기기, 050서비스) 내 알림 내역 (친구초대, 내글좋아요, 댓글등알림)',
  },
  {
    title: '10. 소셜기능   ',
    content: '1:1문의 채팅(기능이나 복잡도에 따라 차이남) 팔로잉 웹공유기능 (페북, 트위터등 공유) 앱공유기능 (앱에서 페북, 카톡공유. 네이티브 SDK연동) 권한 및 등급관리',
  },
]
    ...
    <div class="about-us">
      <div class="about-us__wrapper">
        ...
        <div class="about-us__content">
          <span>About Us</span>
          <h2 class="about__heading">WSOFT는 최첨단 IT 기술을 바탕으로, 비즈니스의 운영 최적화와 목표 달성을 위한 혁신적인 솔루션을 제공하기 위해 노력하는 회사입니다.우리는 비즈니스의 성장을 위해 최선을 다하며, 함께 성공을 이루어 나갈 수 있도록 끊임없이 노력합니다</h2>
          <h2 class="about__heading">WSOFT IS A CUTTING-EDGE IT COMPANY DEDICATED TO DELIVERING INNOVATIVE SOLUTIONS TO HELP BUSINESSES OPTIMIZE THEIR OPERATIONS AND ACHIEVE THEIR GOALS.</h2>
          <p class="about__text">With a team of highly skilled and experienced professionals, provides a comprehensive suite of services, including software development, cloud computing, cybersecurity, and digital marketing. We leverage the latest technologies and best practices to deliver customized solutions that meet the unique needs of our clients.</p>
          <button class="inquire-button margin-not-center default-btn" v-on:click="navigateTo('about')">Explore Now</button>
        </div>
      </div>
    </div>
